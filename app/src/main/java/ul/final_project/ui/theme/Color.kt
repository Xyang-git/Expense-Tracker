...
// Expense Category Colors (Used in Light & Dark)
val FoodCategoryColor = Color(0xFFFF322E)
val TransportCategoryColor = Color(0xFFFFA000)
val HealthCategoryColor = Color(0xFF2597FF)
val EntertainmentCategoryColor = Color(0xFF2DAB35)
val ShoppingCategoryColor = Color(0xFFB86CD9)
val SubscriptionCategoryColor = Color(0xFF4AB5C7)
val OtherCategoryColor = Color(0xFF757575)

fun  CategoryIndicator(category: String) : Color {
    val color = when (category) {
        "Food" -> FoodCategoryColor
        ...
        "Subscription" -> SubscriptionCategoryColor
